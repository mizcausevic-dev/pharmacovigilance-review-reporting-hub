...
const checks = [
  ...
  ["Title matches", html.includes("Pharmacovigilance Review and Reporting Hub")],
  ...
  ["CNAME = pv.kineticgain.com", readFileSync(new URL("CNAME", root), "utf8").trim() === "pv.kineticgain.com"],
